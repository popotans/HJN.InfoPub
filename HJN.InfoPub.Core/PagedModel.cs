...
namespace HJN.InfoPub.Core
{
    ...
    public class PagedModel
    {
        ...
        public string GetPager(Dictionary<string, string> dic, string uriPath = "")
        {
            return GetPager(this.TotalPage, this.Page, dic, uriPath);
        }
        ...
        /// <returns></returns>
        public string GetPager(int pageCount, int currentPage, Dictionary<string, string> dic, string uriPath = "")
        {
            ...
            if (pageFoot == pageCount)
            {
                if (pageCount > currentPage)
                {
                    ...
                    sb.Append("<td><a href='" + uriPath + "?page=" + pageCount.ToString() + pString + "' title='尾页'>尾页</a></td>\r");
                }
            }
            else
            {
